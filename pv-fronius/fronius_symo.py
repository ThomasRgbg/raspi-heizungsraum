...
class Symo:
    def __init__(self, ipaddr, model="autodetect"):
        ...
        # Storage device (Battery)
            ...
            "Battery_OutWRte" : [[40366,40379], "uint16_sunssf", 1],
            "Battery_InWRte" : [[40367,40379], "uint16_sunssf", 1],
        ...
        if self.model == "autodetect":
            name = self.read_string(40021, 16)
            if "GEN24" in name:
    ...
    def print_raw(self):
        ...
        for i in range(40354,40354+24,1):
